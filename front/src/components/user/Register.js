...
export const Register = () => { //emaquetar información, nueva forma
    ...
    const onChange = e => {
        if (e.target.name === "avatar") {
            ...
            setUser({ ...user, [e.target.name]: e.target.value }) //con esta linea se culmina la asignación onchange con el value
        }
    }
