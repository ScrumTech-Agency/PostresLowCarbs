...
exports.newOrder= catchAsyncErrors(async (req, res, next)=>{
    const {items, envioInfo, precioItems, pagoInfo, precioImpuesto, precioEnvio, precioTotal}= req.body;
    
    const order= await Order.create({
        items, envioInfo, precioItems, pagoInfo, precioImpuesto, precioEnvio, precioTotal, fechaPago: Date.now(), user: req.user._id
    })
